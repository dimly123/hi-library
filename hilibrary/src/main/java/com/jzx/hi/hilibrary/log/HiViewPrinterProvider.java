...
import com.jzx.hi.hilibrary.util.HiDisplayUtil;
...
public class HiViewPrinterProvider {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = HiDisplayUtil.dp2px(249, recyclerView.getResources());
    ...
    private void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, HiDisplayUtil.dp2px(249, rootView.getResources()));
    ...
    private View genLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, HiDisplayUtil.dp2px(249, rootView.getResources()));
